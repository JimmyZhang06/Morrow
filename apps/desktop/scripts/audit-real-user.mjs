...
const evidence = resolve('../../.data/real-user-audit');
await mkdir(evidence,{recursive:true});
const directory = await mkdtemp(join(tmpdir(),'morrow-real-user-'));
...
const executablePath=resolve('release-visual-refresh/win-unpacked/Morrow.exe');
let app, page;
