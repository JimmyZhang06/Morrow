...
try {
  ...
  const evidence=resolve('../../.data/release-evidence/chinese-theme');
  ...
  console.log('Single API protocol, preserved conversation, 30 stable navigation frames, reload route and visual screenshots passed.');
